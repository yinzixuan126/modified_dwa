...
#include <iri_atr_akp_local_planner_companion/AkpLocalPlannerConfig.h>
...
#define LAUNCH_GOAL     	     iri_common_drivers_msgs::ps3state::PS3_BUTTON_ACTION_CROSS
// [publisher subscriber headers]
...
class AkpLocalPlanner : public nav_core::BaseLocalPlanner
{
  ...
  private:
    ...
    /*ros::Subscriber tracks_subscriber_;
    void tracks_callback_ATR(const layer2::HTEntityList::ConstPtr& msg);
    pthread_mutex_t tracks_mutex_;
    void tracks_mutex_enter(void);
    void tracks_mutex_exit(void);*/
    ...
    dynamic_reconfigure::Server<iri_atr_akp_local_planner_companion::AkpLocalPlannerConfig> *dsrv_;
    iri_atr_akp_local_planner_companion::AkpLocalPlannerConfig default_config_;
	...
	bool fake_change_ids_and_desapear_;
...
//nav_core::BaseGlobalPlanner check_posible_path_move_base_;
  ...
  Cperson_abstract::companion_reactive reactive_;
	...
	bool bool_use_fake_person_;
	double x_velodine_, y_velodine_;

	bool change_ids_group_people_in_node_;
	
	unsigned int id_second_person_generate_facke_track_desapear_;
	unsigned int id_first_person_generate_facke_track_desapear_;

	bool true_ZanlungoCompModel_;
...
/* obtain near persons with ps3 button */
 ...
 /**
    ...
    */
    //Config config_;
    iri_atr_akp_local_planner_companion::AkpLocalPlannerConfig config_;
    ...
    bool stop_robot_ATR_;
	bool restart_robot_ATR_;

	double before_tim;

	bool we_have_person_fake_;

	bool remove_second_person_comp_test_fake_;
  ...
  protected:
    ...
    *               has been changed.
    */
    void reconfigureCallback(iri_atr_akp_local_planner_companion::AkpLocalPlannerConfig &config, uint32_t level);
