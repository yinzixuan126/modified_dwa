...
#ifndef _akp_local_planner_car_alg_h_
#define _akp_local_planner_car_alg_h_

#include <iri_akp_local_planner_car/AkpLocalPlannerConfig.h>
...
class AkpLocalPlannerAlgorithm
{
  ...
  public:
    ...
    * will then use the same variable type Config.
    */
    typedef iri_akp_local_planner::AkpLocalPlannerConfig Config;
